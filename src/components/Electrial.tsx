            ...
            <Grid2 container spacing={2}>
                ...
                <Grid2 xs={12} md={5.5}>
                    ...
                    <Grid2 container sx={{ padding: '18px 3px' }}>
                        ...
                        <Grid2 xs={6} sx={{ width: '50%', marginTop: '20px' }} >
                            <Typography sx={{ fontSize: '13px', fontFamily: 'Outfit', fontWeight: 500 }}>
                            Engine: Visual (Leaks, Seepage, missing loose fasteners or component appearance)
                            </Typography>
...
{/* left side ended here */}
            ...
            <Grid2 container sx={{ padding: '18px 3px' }}>
                ...
                <Grid2 xs={12} container justifyContent="space-between">
                    {/* imgage 1 will be in box 1 and similaryly 2 nd 3 */}
                    <Box sx={{ width: '32%', height: '209px', backgroundColor: '#E0E0E0' }} />
                    <Box sx={{ width: '32%', height: '209px', backgroundColor: '#E0E0E0' }} />
                    <Box sx={{ width: '32%', height: '209px', backgroundColor: '#E0E0E0' }} />
              ...
              {/* Placeholder for image slots */}
                <Grid2 xs={12} container justifyContent="flex-start" sx={{ marginTop: '20px' }}>
                    {/* Image 1 in box 1 and image 2 in box 2 */}
                    <Box sx={{ width: '32%', height: '209px', backgroundColor: '#E0E0E0', marginRight: '25px' }} />
                    <Box sx={{ width: '32%', height: '209px', backgroundColor: '#E0E0E0' }} />
                </Grid2>
